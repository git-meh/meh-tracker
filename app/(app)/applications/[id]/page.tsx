    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            <span className="w-20 text-sm text-muted-foreground">Privacy</span>
          ...
          {app.matchedScore ? (
            <div className="flex items-center gap-4">
              <span className="w-20 text-sm text-muted-foreground">Match</span>
              <span className="text-sm">
                {app.matchedScore} ·{" "}
                {app.matchReason ?? "Generated from profile matching"}
              </span>
            </div>
          ) : null}
          <div className="flex items-center gap-4">
            <span className="w-20 text-sm text-muted-foreground">Source</span>
            <span className="text-sm">
              {JOB_SOURCE_TYPE_LABELS[app.jobSourceType]}
            </span>
          </div>
          <div className="flex items-center gap-4">
            <span className="w-20 text-sm text-muted-foreground">
            ...
            <span className="text-sm">
              {app.automationMode.replace(/_/g, " ")} · {app.submissionAttempts}{" "}
              attempt
      ...
      <Card>
        ...
        <CardContent>
          {runs.length === 0 ? (
            <p className="text-sm text-muted-foreground">
              No submission runs yet. Approving an AI draft or future automation
      ...
      <Card>
        ...
        <CardContent>
          {history.length === 0 ? (
            ...
            <ol className="relative ml-3 space-y-4 border-l border-muted">
              {history.map((h) => (
